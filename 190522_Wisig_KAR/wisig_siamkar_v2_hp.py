...
try:
    res_df = pd.read_csv(res_path + 'res_df_v4.csv')
...
desc = 'def_siamese_karlast1024_hardpos'
...
for rseed  in seeds:
    for model_type in types:        
        ...
        for splits in range(len(data_skf)):
            ...
            if model_type==0:
                #reimport
                siamkar_v2_hp = reload(siamkar_v2_hp)
                karnet_v1 = reload(karnet_v1)
                from karnet_v1 import KARnet
                from siamkar_v2_hp import SiamKar_Loader
                from siamkar_v2_hp import siamtri_net
                ...
                #reimport
                siamkar_v2_hp = reload(siamkar_v2_hp)
                from siamkar_v2_hp import SiamTri_Loader
                from siamkar_v2_hp import siamtri_net
                ...
                #reimport
                siamkar_v2_hp = reload(siamkar_v2_hp)
                from siamkar_v2_hp import Siamese_Loader
                from siamkar_v2_hp import siamese_net
            ...
            res_df.to_csv(res_path + 'alldata_res_df_v4.csv',index=False)