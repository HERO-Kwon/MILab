...
xtest = x[ind_train].reshape(1,-1)
ytest = y[ind_train].reshape(1,-1)
fxytest = f_xy[ind_train].reshape(1,-1)
...
print('Accuracy:', m1.get_accuracy(batch_xtest,batch_ytest,batch_fxytest))