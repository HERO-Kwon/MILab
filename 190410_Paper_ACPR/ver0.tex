...
\begin{document}
%
\title{Direction-Free In-Air Signature Verification Using WIFI CSI Signal\thanks{Supported by organization x.}}
%
...
Gathering CSI signal, Make CSI Image
\subsection{Siamese Network For Verification}
i. Feature Extraction
- Symmetric CNN Architecture
