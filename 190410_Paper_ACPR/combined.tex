...
\begin{figure}[!h]
   \begin{center}
   \subfigure[][Analysis on image brightness changes]{
        \includegraphics[height=6.2cm]{fig_roc_v9.eps}}
   \subfigure[][Analysis on image contrast changes]{
        \includegraphics[height=6.2cm]{normalized_loss_curve_ma30_v1.eps}}
