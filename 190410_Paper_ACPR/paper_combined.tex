...
\begin{figure}[!h]
    \begin{center}
    \subfigure[][ROC Curve]{
         \includegraphics[height=6.4cm]{fig_roc_v9.eps}}
    \subfigure[][Training Loss Curve]{
         \includegraphics[height=6.4cm]{normalized_loss_curve_ma30_v1.eps}}
 ...
 % merged 2 graph: omitted separated graph
 \iffalse
 % Figure 3
 \begin{figure}[!h]
