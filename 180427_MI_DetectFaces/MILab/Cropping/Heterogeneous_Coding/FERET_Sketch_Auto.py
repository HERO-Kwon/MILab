...
points_folder_path = '/home/han/Desktop/Photo-Sketch/CUFSF/Sketch/sketch_points/'
image_folder_path = '/home/han/Desktop/Photo-Sketch/CUFSF/Sketch/original_sketch/'
save_path = '/home/han/Desktop/Hetero/FERET/FERET_Sketch_Cropped/'
...
for root, dirs, files in os.walk(points_folder_path): #select a volume among volume list
    ...
    for points_name in files:
        ...
        image_name = points_name[:-5] + '.jpg' # Sketch
